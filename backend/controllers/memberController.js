...
const generateTrialMemberId =
  require("../utils/trialMemberIdGenerator");
...
exports.addMember =
  async (
    ...
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            ...
            message:
              `Member already exists with this phone number. Member ID: ${existingMember._id}`,
          });
      }
      ...
      //
      // TRIAL:
      // trialMemberIdGenerator
      //
      // NORMAL ADMIN:
      // existing memberIdGenerator
      //
      // Normal admin ka generator bilkul unchanged.
      // ==================================================
...
exports.getAllMembers =
  async (
    ...
    try {
      ...
      // Prevent regex special characters
...
exports.updateMember =
  async (
    ...
    try {
      ...
      // Existing phone behavior unchanged.
...
exports.deleteMember =
  async (
    ...
    try {
      ...
      // Current gym payment records only.
